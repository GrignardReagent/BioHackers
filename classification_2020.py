...
def zero_shot_classification(image, idx):
    ...
    classes = ["residential", "industrial", "water", "forest", "farm"]
    with torch.no_grad():
...
# -------------------------------
# 5. Directly Split into 20x20 Grid and Classify
# -------------------------------
def grid_classification(image, grid_size=20):
...
# -------------------------------
# 7. Save Classification Results (Only save scores images)
# -------------------------------
results_json = {}
